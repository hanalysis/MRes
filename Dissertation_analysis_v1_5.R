...
CTQ_BDI_subscale_vis <- Primary_data %>%
  ...
  geom_smooth(aes(y = CTQ_PA_Score, color = "Physical abuse"), linewidth = 2, se = FALSE) + 
  geom_smooth(aes(y = CTQ_EA_Score, color = "Emotional abuse"), linewidth = 2, se = FALSE) + 
  geom_smooth(aes(y = CTQ_PN_Score, color = "Physical neglect"), linewidth = 2, se = FALSE) + 
  geom_smooth(aes(y = CTQ_EN_Score, color = "Emotional neglect"), linewidth = 2, se = FALSE) + 
  geom_smooth(aes(y = CTQ_SA_Score, color = "Sexual abuse *"), linewidth = 2, se = FALSE) + 
  labs(x = "BDI score", 
